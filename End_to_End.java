...
public class End_to_End {
        ...
        @Test
        public void Login_and_Book_Flight() {
            ...
            WebElement wb = driver.findElement(By.name("billAddress1"));
                wb.clear();
                wb.sendKeys("Paras Tierea");
            driver.findElement(By.name("billAddress2")).sendKeys("Sector-137");
            ...
            WebElement wb5 = driver.findElement(By.name("delAddress1"));
                wb5.clear();
                wb5.sendKeys("Paras Tierea");
            driver.findElement(By.name("delAddress2")).sendKeys("Sector-137");
            ...
            assertEquals(GenTitle, ConfirmationPage);
        }
    }
